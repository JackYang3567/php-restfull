...
CREATE TABLE `payment` (
  ...
  `method` bigint(1)  NULL  COMMENT 'paymethod id 支付方式1:支付宝,2:微信支付,3:微信支付官方,4:QQ钱包支付,5:QQ钱包支付官方',  
  `amount` decimal(8,2)  NULL DEFAULT '0' COMMENT '支付金额', 
  `payer` varchar(50) NOT NULL DEFAULT '0' COMMENT '付款人姓名',
  `time`  timestamp NULL DEFAULT NULL COMMENT '付款时间',  
  `pay_account_four`varchar(50)  NULL DEFAULT '0' COMMENT '付款账号后4位',  
...
INSERT INTO  `paymethod` (`name`,`code`,`icon_path`,`qrcode_path`,`sortId`) VALUES ('支付宝','alipay','/index/images/method-ali.png','/index/images/Ali_QrCode.png','1');
INSERT INTO  `paymethod` (`name`,`code`,`icon_path`,`qrcode_path`,`sortId`) VALUES ('微信','Weixin','/index/images/method-wx.png','/index/images/Weixin_QrCode.png','2');
INSERT INTO  `paymethod` (`name`,`code`,`icon_path`,`qrcode_path`,`sortId`) VALUES ('微信官方','Weixin_gf','/index/images/method-wx.png','/index/images/Weixin_QrCode_gf.png','3');
INSERT INTO  `paymethod` (`name`,`code`,`icon_path`,`qrcode_path`,`sortId`) VALUES ('QQ钱包','QQwallet','/index/images/method-qq.png','/index/images/QQwallet_QrCode.png','4');
INSERT INTO  `paymethod` (`name`,`code`,`icon_path`,`qrcode_path`,`sortId`) VALUES ('QQ钱包官方','QQwallet_gf','/index/images/method-qq.png','/index/images/QQwallet_gf_QrCode.png','5');
...
-- ========================================
-- 视图
DROP VIEW IF EXISTS `view_payment_method` ;
 CREATE VIEW `view_payment_method` AS 
 select p.*, t.name
 from payment p  left join paymethod t on t.Id= p.method
